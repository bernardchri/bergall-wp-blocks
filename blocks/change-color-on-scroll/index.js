...
registerBlockType('animablocks/change-color-on-scroll', {
                ...
                <InspectorControls>
                    <PanelBody title="Settings">
                        ...
                        <ToggleControl
                            label="Add Class"
                            checked={addClass}
                            onChange={(val) => setAttributes({ addClass: val })}
                        />
                    </PanelBody>
                </InspectorControls>
                <div {...blockProps} ref={blockRef}>
                    <div style={{ backgroundColor }}>
                    Changement de couleur du body partir de ce composant :  {backgroundColor}
                    </div>
                </div>
            </>
        );
    ...
    save({ attributes }) {
        ...
        return (
            <div {...useBlockProps.save()} data-background-color={backgroundColor}>
            </div>
        );
    },
});
