    ...
    >
      {slides.length > 0 ? (
        <>
          ...
          <NavigationSwiper navigationDisplay={true} paginationDisplay={true} />
        </>
      ) : (
  ...
  sliders.forEach(slider => {
    ...
    if (!slider.classList.contains('swiper-initialized')) {
      new Swiper(slider, {
        ...
        breakpoints: {
          0: { slidesPerView: parseInt(slider.dataset.slidesMobile) || 1 },
          768: { slidesPerView: parseInt(slider.dataset.slides) || 1 }
        }
      });
