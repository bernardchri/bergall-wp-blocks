    ...
    const observer = new IntersectionObserver(entries => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_7__["default"].to('.animated-paragraph', {
            opacity: 1,
            duration: 1,
            delay: 0
          });
          ...
          splitResult[0][animationType].forEach((element, index) => {
            gsap__WEBPACK_IMPORTED_MODULE_7__["default"].from(element, {
              opacity: 0,
              y: 20,
              duration: duration,
...
/***/ "./blocks/change-color-on-scroll/index.js":
/*!************************************************!*\
  !*** ./blocks/change-color-on-scroll/index.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const animateBackgroundColor = (element, backgroundColor, addClass, blockRef) => {
  if (element) {
    const defaultColor = getComputedStyle(element).backgroundColor;
    gsap__WEBPACK_IMPORTED_MODULE_5__["default"].utils.toArray('.wp-block-bergalblocks-change-color-on-scroll').forEach(section => {
      let lastColor = defaultColor;
      gsap__WEBPACK_IMPORTED_MODULE_5__["default"].fromTo(element, {
        ...
        scrollTrigger: {
          ...
          onEnter: () => {
            ...
            if (addClass) {
              console.log("enter");
              element.classList.add('change-color-on-scroll');
          ...
          onLeaveBack: () => {
            if (addClass) {
              element.classList.remove('change-color-on-scroll');
            }
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('bergalblocks/change-color-on-scroll', {
  ...
  edit({
    ...
    const blockRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useRef)();
    const [targetValue, setTargetValue] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)('body');
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
      if (targetElement) {
        const element = document.querySelector(targetElement);
        animateBackgroundColor(element, backgroundColor, addClass, blockRef);
      }
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
          title: "Settings",
          children: [targetElement, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.ColorPalette, {
            colors: [{
              name: 'gray',
              color: '#999999'
            }
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
          ...
          children: ["Changement de couleur du body partir de ce composant :  ", backgroundColor]
        })
      })]
    });
  },
...
document.addEventListener("DOMContentLoaded", function () {
  gsap__WEBPACK_IMPORTED_MODULE_4__["default"].utils.toArray(".parallax-container").forEach(container => {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_4__["default"].fromTo(container.querySelector(".parallax-content"), {
      y: speed
    }, {
      ease: "none",
      y: -speed,
  ...
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_5__.ScrollTrigger.refresh(); // Force recalculation of positions
});
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('bergallblocks/group-extended', {
  ...
  save: ({
    ...
    return href ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("a", {
      href: href,
...
document.addEventListener("DOMContentLoaded", function () {
  if (!gsap__WEBPACK_IMPORTED_MODULE_5__["default"]) {
    return;
  }
  if (document.querySelector('.wp-block-bergallblocks-group-extended')) {
    gsap__WEBPACK_IMPORTED_MODULE_5__["default"].utils.toArray(".animate-fadeIn, .animate-fadeInUp").forEach(element => {
      gsap__WEBPACK_IMPORTED_MODULE_5__["default"].fromTo(element, {
        opacity: 0,
        y: element.classList.contains("animate-fadeInUp") ? 50 : 0,
        display: "block"
      }, {
        opacity: 1,
        y: 0,
...
const applyScrollAnimation = (initialScale, zIndex, start, end) => {
  gsap__WEBPACK_IMPORTED_MODULE_6__["default"].utils.toArray('.scale-on-scroll').forEach(section => {
    gsap__WEBPACK_IMPORTED_MODULE_6__["default"].fromTo(section, {
      scale: initialScale,
      zIndex: 1
    }, {
      scale: 1,
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./blocks/slider-image/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit({
    ...
    const addImagesToSlide = images => {
      ...
      setAttributes({
        slides: [...attributes.slides, ...newSlides]
      });
    };
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
      const sliderswiper = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('.swiper-container', {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          ...
          children: attributes.slides.map((slide, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
  ...
  save({
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
          className: "swiper-wrapper",
          children: attributes.slides.map((slide, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
            className: "swiper-slide",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("img", {
              src: slide.image,
              alt: slide.alt
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  sliders.forEach(slider => {
    ...
    const sliderswiper = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](slider.querySelector('.bergall-swiper-container'), {
...
/* harmony import */ var _blocks_slider_image__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../blocks/slider-image */ "./blocks/slider-image/index.js");
/* harmony import */ var _blocks_marquee__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../blocks/marquee */ "./blocks/marquee/index.js");
/* harmony import */ var _blocks_change_color_on_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../blocks/change-color-on-scroll */ "./blocks/change-color-on-scroll/index.js");
/* harmony import */ var _blocks_container_parallax__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../blocks/container-parallax */ "./blocks/container-parallax/index.js");
/* harmony import */ var _blocks_group_extended__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../blocks/group-extended */ "./blocks/group-extended/index.js");
/* harmony import */ var _blocks_scale_on_scroll__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../blocks/scale-on-scroll */ "./blocks/scale-on-scroll/index.js");
...
/***/ "./blocks/slider-image/block.json":
/*!****************************************!*\
  !*** ./blocks/slider-image/block.json ***!
  \****************************************/
/***/ ((module) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"bergall/slider-image","title":"Slider Image","category":"bergall","icon":"images-alt","description":"Un slider d\'images","supports":{"html":false},"attributes":{"slides":{"type":"array","default":[]},"numberofslides":{"type":"number","default":1}},"editorScript":"file:./index.js","style":"file:./style.css"}');
