...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('custom/animated-paragraph', {
  attributes: {
    duration: {
      type: 'number',
      default: 0.300
...
/***/ "./src/gsap/minified/utils/SplitText.min.js":
/*!**************************************************!*\
  !*** ./src/gsap/minified/utils/SplitText.min.js ***!
  \**************************************************/
...
!function (a) {
  ...
  var b = a.GreenSockGlobals || a,
    ...
    E = function (a, b, c, d, e, h, j) {
      ...
      if (P || S) for (k = 0; m > k; k++) n = o[k], p = n.parentNode === a, (p || S || R && !Q) && (v = n.offsetTop, P && p && Math.abs(v - y) > H && ("BR" !== n.nodeName || 0 === k) && (q = [], P.push(q), y = v), S && (n._x = n.offsetLeft, n._y = v, n._w = n.offsetWidth, n._h = n.offsetHeight), P && ((n._isSplit && p || !R && p || Q && p || !Q && n.parentNode.parentNode === a && !n.parentNode._isSplit) && (q.push(n), n._x -= x, C(n, a, M) && (n._wordEnd = !0)), "BR" === n.nodeName && (n.nextSibling && "BR" === n.nextSibling.nodeName || 0 === k) && P.push([])));
  ...
  H.split = function (a) {
    ...
    for (var b, c, d, e = this.elements.length, f = a.span ? "span" : "div", g = x(a.wordsClass, f), h = x(a.charsClass, f); --e > -1;) d = this.elements[e], this._originals[e] = d.innerHTML, b = d.clientHeight, c = d.clientWidth, G(d, a, g, h), E(d, a, this.chars, this.words, this.lines, c, b);
...
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _blocks_animated_paragraph___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../blocks/animated-paragraph/ */ "./blocks/animated-paragraph/index.js");
...
/* harmony import */ var _gsap_minified_utils_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../gsap/minified/utils/SplitText.min.js */ "./src/gsap/minified/utils/SplitText.min.js");
/* harmony import */ var _gsap_minified_utils_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gsap_minified_utils_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0__);


gsap__WEBPACK_IMPORTED_MODULE_1__["default"].registerPlugin((_gsap_minified_utils_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0___default()));
document.addEventListener('DOMContentLoaded', function () {
  // Définir l'opacité à 0 pour tous les éléments avec la classe 'animated-paragraph'
  gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set('.animated-paragraph', {
    opacity: 0
  });
  const observer = new IntersectionObserver(entries => {
    entries.forEach(entry => {
      if (entry.isIntersecting) {
        ...
        const splitText = new (_gsap_minified_utils_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0___default())(paragraph, {
          type: 'words'
        });
        ...
        gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to('.animated-paragraph', {
          opacity: 1,
          duration: 1,
          delay: 0
        });
        gsap__WEBPACK_IMPORTED_MODULE_1__["default"].fromTo(splitText.words, {
          opacity: 0,
          y: 20
        }, {
          duration: duration,
