		...
		<InspectorControls>
			...
			<PanelBody title="Opacité" initialOpen={ true }>
				<RangeControl
					...
					value={ startOpacity }
					onChange={ ( value ) =>
						setAttributes( { startOpacity: Number( value ) } )
					}
					min={ 0 }
					max={ 1 }
					step={ 0.1 }
				...
				<RangeControl
					...
					value={ endOpacity }
					onChange={ ( value ) =>
						setAttributes( { endOpacity: Number( value ) } )
					}
					min={ 0 }
					max={ 1 }
					step={ 0.1 }
			...
			<PanelBody title="Scale Settings">
				<RangeControl
					...
					value={ initialScale }
					onChange={ ( value ) =>
						setAttributes( { initialScale: Number( value ) } )
					}
					min={ 0 }
					max={ 10 }
					step={ 0.1 }
				...
				<RangeControl
					...
					value={ finalScale }
					onChange={ ( value ) =>
						setAttributes( { finalScale: Number( value ) } )
					}
					min={ 0 }
					max={ 10 }
					step={ 0.1 }
			...
			<PanelBody title="Rotation Animation" initialOpen={ false }>
				<TextControl
					...
					value={ startRotate }
					onChange={ ( value ) =>
						setAttributes( { startRotate: Number( value ) } )
					}
				/>
				<TextControl
					__nextHasNoMarginBottom
					...
					value={ endRotate }
					onChange={ ( value ) =>
						setAttributes( { endRotate: Number( value ) } )
					}
				/>
			</PanelBody>
			<PanelBody title="Déclencheurs scroll" initialOpen={ false }>
				<SelectControl
					...
					onChange={ ( value ) =>
						setAttributes( { debug: value === 'true' } )
					}
				/>
				<TextControl
					__nextHasNoMarginBottom
					...
					onChange={ ( value ) =>
						setAttributes( { scrollEnterElement: value } )
					}
					help='Exemple : "bottom"'
				/>
				<TextControl
					...
					onChange={ ( value ) =>
						setAttributes( { scrollEnterViewport: value } )
					}
					help='Exemple : "top"'
				/>
				<TextControl
					...
					onChange={ ( value ) =>
						setAttributes( { scrollLeaveElement: value } )
					}
					help='Exemple : "center"'
				/>
				<TextControl
					...
					onChange={ ( value ) =>
						setAttributes( { scrollLeaveViewport: value } )
					}
					help='Exemple : "center"'
				/>
