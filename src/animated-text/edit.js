...
export default function Edit( { attributes, setAttributes, clientId } ) {
	...
	const resetDuration = () =>
		setAttributes( { duration: metadata.attributes.duration.default } );
	const resetStagger = () =>
		setAttributes( { stagger: metadata.attributes.stagger.default } );
	const resetDelay = () =>
		setAttributes( { delay: metadata.attributes.delay.default } );
